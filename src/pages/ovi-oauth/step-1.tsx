...
export default function OAuthStep1() {
  ...
  document.title = t('OAuth Step 1 - {{title}}', { title: siteConfig.title })

  return (
    <div className="mx-auto w-full max-w-5xl p-4">
      <div className="rounded bg-white p-3 dark:bg-gray-900 dark:text-gray-100">
        <div className="mx-auto w-52">
          <img src="/images/fabulous-fireworks.png" width={912} height={912} alt="fabulous fireworks" />
        </div>
        ...
        <div className="mb-2 mt-6 text-right">
          <button
            ...
            onClick={() => {
              navigate('/onedrive-vercel-index-oauth/step-2')
            }}
          >
